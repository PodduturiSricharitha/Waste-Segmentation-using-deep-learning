def get_disposal_instructions(detected_classes):
    rules = {
    ...
    instructions = [
        f"<div class='instruction'>{rules.get(cls, 'No specific instructions available.')}</div>"
        for cls in detected_classes
    ]

    return "<br><br>".join(instructions)
